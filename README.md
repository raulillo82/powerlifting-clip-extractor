...
```
lifts/
├── lift_01_squat_attempt1.mp4
├── lift_02_squat_attempt2.mp4
├── lift_03_squat_attempt3.mp4
├── lift_04_bench_attempt1.mp4
...
├── lift_09_deadlift_attempt3.mp4
└── combined_s3_b3_d3.mp4      ← Instagram, 3 levantamientos apilados
```

Todos los archivos son MP4 / H.264 / AAC con `-movflags +faststart`, compatibles con Instagram y WhatsApp.
...
...
├── lift_09_deadlift_attempt3.mp4
└── combined_s3_b3_d3.mp4      ← Instagram-compatible, 3 lifts stacked
```

All files are MP4 / H.264 / AAC with `-movflags +faststart`, compatible with Instagram and WhatsApp.
